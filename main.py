...
from object.crud import download_file_and_upload_to_s3, get_objects, upload_local_file, delete_object_version, delete_object_versions_before_specific_version_id
    ...
    match args.command:
        ...
        case "object":
            ...
            if args.name:
                ...
                if args.delete_object_by_version:
                    delete_object_version(s3_client, args.bucket_name, args.name, args.delete_object_by_version)

                if args.delete_all_after_specific_version_id:
                    delete_object_versions_before_specific_version_id(s3_client, args.bucket_name, args.name, args.delete_all_after_specific_version_id)
