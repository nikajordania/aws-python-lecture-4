...
def delete_object_version(aws_s3_client, bucket_name, file_name, version_id):
...
def delete_object_versions_after_specific_version_id(aws_s3_client, bucket_name, file_name, version_id):
...
def delete_object_versions_before_specific_version_id(aws_s3_client, bucket_name, file_name, version_id):
    versions = aws_s3_client.list_object_versions(
        Bucket=bucket_name,
        Prefix=file_name
    )
